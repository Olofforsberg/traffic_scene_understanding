...
//  cv::waitKey(0);
  return output_image, output_layer;
...
//  }
  ...
  string model_file   = ROOT_SAMPLE + "/model/segnet_model_driving_webdemo.prototxt";
  string trained_file = ROOT_SAMPLE + "/model/segnet_iter_30000_timo.caffemodel";

  //::google::InitGoogleLogging(model_file);
  ...
  string file = ROOT_SAMPLE + "/random_img.jpg";
  string LUT_file = ROOT_SAMPLE + "/model/camvid12.png";
